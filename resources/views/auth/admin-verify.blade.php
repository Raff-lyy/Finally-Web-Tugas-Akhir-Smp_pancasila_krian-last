...
<head>
  ...
  <title>Verifikasi OTP - Admin SMP Pancasila Krian</title>
...
<body class="min-h-screen flex items-center justify-center bg-gray-100">
  ...
  <div class="w-full max-w-md bg-white shadow-lg rounded-xl p-8 animate-slide-up">
    <h2 class="text-2xl font-bold text-indigo-800 text-center mb-4">Verifikasi OTP</h2>
    <p class="text-center text-gray-600 mb-6">
      Masukkan kode OTP yang telah dikirim ke email Anda. Berlaku 10 menit.
    </p>
